	...
	<body>
		...
		<div class="content">
			<fieldset>
				...
				<? if ($ini_array['JACKBUFFER'] != "8192") print "${measurement_buffer_warning._.$lang}" ; ?> <br><br>
				...
				<? if ( isset($_POST['start_measurement']) )
				{
					...
					?> </pre>
					<input type="submit" value=" <? print ${cancel_measurement._.$lang} ?> " name="cancel_measurement"> <?
					measurement();
